...
UI::SettingsWidget::SettingsWidget(QWidget *parent)
  ...
  connect(slider1_, &QSlider::valueChanged,
          [this](int value) { valueEdit1_->setText(QString::number(value)); });
  connect(slider2_, &QSlider::valueChanged,
          [this](int value) { valueEdit2_->setText(QString::number(value)); });
  connect(slider3_, &QSlider::valueChanged,
          [this](int value) { valueEdit3_->setText(QString::number(value)); });
...
void UI::SettingsWidget::onApplyClicked() {
  int value1 = valueEdit1_->text().toInt();
  int value2 = valueEdit2_->text().toInt();
  int value3 = valueEdit3_->text().toInt();
